...
if [ $(id -u) -ne 0 ]; then
	...
	UBUNTU_RELEASE='artful'
        ...
        debootstrap --variant=buildd --arch amd64 ${UBUNTU_RELEASE} ${CHROOT_GADGETRON_BINARY_DIR}/chroot/chroot-root/gadgetron http://gb.archive.ubuntu.com/ubuntu/
        ...
        chroot ${CHROOT_GADGETRON_BINARY_DIR}/chroot/chroot-root/gadgetron add-apt-repository "deb http://us.archive.ubuntu.com/ubuntu/ ${UBUNTU_RELEASE} main restricted multiverse universe"  
        chroot ${CHROOT_GADGETRON_BINARY_DIR}/chroot/chroot-root/gadgetron apt-get update
        chroot ${CHROOT_GADGETRON_BINARY_DIR}/chroot/chroot-root/gadgetron apt-get install python-h5py libhdf5-serial-dev hdf5-tools python-pip libplplot-dev supervisor -y
